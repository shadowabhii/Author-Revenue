...
public class Transaction {
	...
	public Transaction(Integer tId, String authorName, String readerName, Double price, Date date, Integer quantity,
	...
	public String toString() {
		return "Transaction [tId=" + tId + ", authorName=" + authorName + ", readerName=" + readerName + ", price="
				+ price + ", date=" + date + ", quantity=" + quantity + ", authorNotified=" + authorNotified
